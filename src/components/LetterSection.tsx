                            ...
                            <div className="bg-[#fff8fb] rounded-2xl shadow-[0_20px_50px_rgba(232,120,154,0.25)] border border-[#f4a7be]/40 overflow-hidden">
                                ...
                                <div className="px-7 py-6 text-[#c2547a] space-y-4">
                                    ...
                                    <div className="text-xs leading-7 space-y-3 italic text-[#c2547a]/75">
                                        <p>ครบรอบ 4ปีแล้วนะ ขอแค่เค้ามีอ้วนไปตลอด และเราสองคนรักกันไปนานๆ คอยอยู่ซัพพอร์ตอยู่เป็นเซฟโซนของกันและกัน อยู่เติมความสดใสคอยเป็นคนให้กำลังใจเวลาเหนื่อยล้า คอยโอ๋กันและกัน คอยดุเวลาที่ทำตัวไม่ดี ขอให้ความรักของเราสองคนมีแต่ความสุข และมีแต่สิ่งดีๆเข้ามานะ รักที่สุดในโลกเลยยยย</p>
                                    </div>
